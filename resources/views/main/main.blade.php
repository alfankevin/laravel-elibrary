                ...
                <div class="col-md-12">
                    ...
                    <div class="main-slider pattern-overlay">
                        <div class="slider-item">
                            ...
                            <img src="assets/img/main/main-banner1.jpg" alt="banner" class="banner-image">
                        </div><!--slider-item-->
                        ...
                        <div class="slider-item">
                            ...
                            <img src="assets/img/main/main-banner2.jpg" alt="banner" class="banner-image">
                        </div><!--slider-item-->
                    ...
                    <div class="product-list" data-aos="fade-up">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="product-item">
                                    <figure class="product-style">
                                        <img src="assets/img/main/product-item1.jpg" alt="Books" class="product-item">
                            ...
                            <div class="col-md-3">
                                <div class="product-item">
                                    <figure class="product-style">
                                        <img src="assets/img/main/product-item2.jpg" alt="Books" class="product-item">
                                        <button type="button" class="add-to-cart" data-product-tile="add-to-cart">Add to
                                            Wishlist</button>
                                    </figure>
                                    <figcaption>
                            ...
                            <div class="col-md-3">
                                <div class="product-item">
                                    <figure class="product-style">
                                        <img src="assets/img/main/product-item3.jpg" alt="Books" class="product-item">
                                        <button type="button" class="add-to-cart" data-product-tile="add-to-cart">Add to
                                            Wishlist</button>
                                    </figure>
                                    <figcaption>
                            ...
                            <div class="col-md-3">
                                <div class="product-item">
                                    <figure class="product-style">
                                        <img src="assets/img/main/product-item4.jpg" alt="Books" class="product-item">
                                        <button type="button" class="add-to-cart" data-product-tile="add-to-cart">Add to
                                            Wishlist</button>
                                    </figure>
                                    <figcaption>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <figure class="products-thumb">
                                <img src="assets/img/main/single-image.jpg" alt="book" class="single-image">
                            </figure>
                        </div>
