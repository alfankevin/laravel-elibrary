                            ...
                            <div class="col-md-6">
                                <figure class="products-thumb">
                                    <div style="padding: 12.5px">
                                        <img src="{{ asset('assets/files/image/' . $item->cover) }}" alt="book" class="single-image" style="height: 470px; width 100%; border-radius: .25rem 0 0 .25rem">
                                    </div>
                                </figure>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="product-entry">
                                    ...
                                    <div class="products-content">
                                        <div class="author-name text-capitalize">By {{ $item->author }}</div>
                                        <h3 class="item-title text-capitalize">{{ $item->title }}</h3>
                                        <p>{{ $item->description }}</p>
                                        <div class="btn-wrap">
